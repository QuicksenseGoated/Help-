...
// Network-first for navigation requests (so you always get the latest app shell
// when online), falling back to cache when offline. Cache-first for everything
// else (icons, manifest) since those rarely change.
